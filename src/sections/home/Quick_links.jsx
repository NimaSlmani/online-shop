  ...
  return (
    <Container bg='bg-yellow-200'>
        <div className='lg:flex'>
            <div className='mb-[10px] lg:w-7/12 lg:mb-0'>
                <Primary_Title text='Sunt In Culpa Qui Officia Deserunt'/>
                <p className='text-14 text-black-100 font-robotoReqular mt-[7px]'>Lorem Ipsum Dolor Sit Amet, Consectetur Adipiscing Elit, Sed Do Eiusmod Tempor Incididunt Ut Labore Et Dolore Magna Aliqua. Ut Enim Ad Minim Veniam, Quis Nostrud Exercitation Ullamco Laboris Nisi Ut Aliquip Ex Ea Commodo Consequat.</p>
            </div>
            <div className='lg:w-5/12 flex lg:pl-[15px]'>
